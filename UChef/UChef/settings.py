"""
Django settings for UChef project.
...
SECRET_KEY = 'django-insecure-mhb)0@4^le7shxe(u2)v-qa4exyfa=m-d1ei-_uy38ymq&$88a'
...
WSGI_APPLICATION = 'UChef.wsgi.application'
